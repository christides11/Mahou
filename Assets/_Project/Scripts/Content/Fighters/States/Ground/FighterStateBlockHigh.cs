...
{
    public class FighterStateBlockHigh : FighterState
    {
        public override void Initialize()
        {
            base.Initialize();
            PhysicsManager.forceGravity = Vector3.zero;
            (Manager.CombatManager as FighterCombatManager).blockState = BlockStateType.HIGH;
            Debug.Log("High Blocking");
        }
        ...
        public override bool CheckInterrupt()
        {
            ...
            {
                StateManager.ChangeState((ushort)FighterStates.BLOCK_LOW);
                return true;
            }
