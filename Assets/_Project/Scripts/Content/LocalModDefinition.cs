...
{
    [CreateAssetMenu(fileName = "LocalModDefinition", menuName = "Content/Local/ModDefinition")]
    public class LocalModDefinition : ScriptableObject, IModDefinition
    {
        ...
        [NonSerialized] private Dictionary<IFighterDefinition, AsyncOperationHandle> fighterDefinitions
            = new Dictionary<IFighterDefinition, AsyncOperationHandle>();

        [NonSerialized] private Dictionary<IGameModeDefinition, AsyncOperationHandle> gamemodeDefinitions
            = new Dictionary<IGameModeDefinition, AsyncOperationHandle>();

        [NonSerialized] private Dictionary<IMapDefinition, AsyncOperationHandle> mapDefinitions
